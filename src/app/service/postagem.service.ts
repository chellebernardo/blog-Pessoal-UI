...
export class PostagemService {
  ...
  getByIdPostagem (id: number): Observable<Postagem>{
    return this.http.get<Postagem>(`https://backendblogpessoal.herokuapp.com/postagens/${id}`)
  }

  posPostagem (postagem: Postagem): Observable<Postagem>{
  ...
  deletePostagem (id: number){
    this.http.delete(`https://backendblogpessoal.herokuapp.com/postagens/${id}`)
  }
